...
delete_arr_queue("http://localhost:7878", os.environ["RK"], "includeUnknownMovieItems", "Radarr")
delete_arr_queue("http://localhost:8989", os.environ["SK"], "includeUnknownSeriesItems", "Sonarr")
PYEOF
...
show("http://localhost:8989", os.environ["SK"], "includeUnknownSeriesItems", "Sonarr")
show("http://localhost:7878", os.environ["RK"], "includeUnknownMovieItems", "Radarr")
PYEOF
